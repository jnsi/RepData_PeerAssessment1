...
```{r Time_series_plot_the_average_number_steps_taken,fig.keep="all", fig.show="asis"}
...
```{r Compute _total_number_steps_each_day_NA_values_remove,fig.keep="all", fig.show="asis"}
...
```{r Comparing_average_number_steps_taken_per_5_minute_interval_across_weekdays_weekends,fig.keep="all", fig.show="asis"}
